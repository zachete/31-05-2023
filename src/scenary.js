  ...
  pages: [
    ...
    },
    {
      text: [
        ...
        '- Сейчас я запущу консоль эмуляции. Для калибровки местоположения она будет задавать вопросы, на которые тебе нужно будет ответить. Все вопросы будут касаться количественной характеристики объектов вокруг тебя. Т.е. ответом будет являться цифра.',
        '- Ну что, ты готова?',
      ],
      buttonLabel: 'Да',
    },
